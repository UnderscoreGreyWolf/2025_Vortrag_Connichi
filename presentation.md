...
<ul class="social-list">
    ...
    <address class="social">
        ...
        <a href="https://twitter.com/german_greywolf">
                <img src="twitter_gw.png" class="social-qr qrcode" alt="Link to Twitter"/>
        </a>
    </address>
    </li>
    <li>
    <address class="social">
        ...
        <a href="https://bsky.app/profile/underscoregreywolf.bsky.social">
            <img src="bsky_gw.png" class="social-qr qrcode" alt="Link to BlueSky"/>
        </a>
    </address>
    </li>
        <li>
    <address class="social">
        ...
        <a href="https://kinkycats.org/@_GreyWolf">
            <img src="fedi_gw.png" class="social-qr qrcode" alt="Link to Mastodon"/>
        </a>
    </address>
    </li>
   <li>
    ...
    <a href="https://fetlife.com/_GreyWolf">
            <img src="fl_gw.png" class="social-qr qrcode" alt="Link to Fetlife"/>
        </a>
    </address>
    </li>
       <li>
    <address class="social">
        <div class="social-title">GitHub:</div>
            ...
            <img src="gh_gw.png" class="social-qr qrcode" alt="Link to GitHub"/>
        </a>
    </address>
    </li>
</ul>
...
<li>
    <address class="social">
        ...
        <a href="https://www.instagram.com/kellygreenycosplay">
            <img src="ig_kg.png" class="social-qr qrcode" height=200px alt="Link to Instagram"/>
        </a>
    </address>
    </li>
</ul>
...
<img src="hojo_cover.jpg" alt="Cover eines Buchs mit einem roten Seil zum Thema 'Hojo Jutsu: Haya Nawa' mit dem Untertitel 'Das schnelle Seil in Budo und Bujutsu' von Norbert Mahl & Walter Baier" height="50%">
...
-->
* Vetting: <a href="https://www.theduchy.com/vetting-a-potential-rope-partner/">www.theduchy.com/vetting-a-potential-rope-partner/<img src="duchy_vetting.png" alt="QR Code" class="qrcode"></a>
<!--
...
<ul>
<li>
<a href="https://www.theduchy.com/general-negotiation-and-planning/">www.theduchy.com/general-negotiation-and-planning/<img src="duchy_negotiation.png" alt="QR Code" class="qrcode"></a>
</li>
<li>
<a href="https://www.theduchy.com/negotiation-forms/">www.theduchy.com/negotiation-forms/<img src="duchy_negotiation_forms.png" alt="QR Code" class="qrcode"></a>
</li>
</ul>
...
<a href="https://www.theduchy.com/risks-when-using-rope/">www.theduchy.com/risks-when-using-rope/<img src="duchy_risks.png" alt="QR Code" class="qrcode"></a>

Siehe auch <a href="https://www.selfsuspend.com/safety">www.selfsuspend.com/safety<img src="selfsuspend_safety.png" class="qrcode" alt="QR Code"></a>
<!--
...
www.youtube.com/watch?v=u9-VzX9_pzg  <img src="yt_anatomy.png" alt="QR Code" class="qrcode"/></a>
* <a href="https://www.theduchy.com/nerves-and-circulation/">www.theduchy.com/nerves-and-circulation/<img src="duchy_nerves.png" alt="QR Code" class="qrcode"></a>
...
* Suspensions sehen beeindruckend aus, aber sind auch sehr riskant
    * Shay Tiziano
        - <a href="https://www.selfsuspend.com">www.selfsuspend.com<img src="selfsuspend.png" alt="QR Code" class="qrcode"/></a>
    ...
    -->
    * TheDuchy(R) <a href="https://www.theduchy.com/"><img src="theduchy.png" class="qrcode" alt="QR Code"/></a>
